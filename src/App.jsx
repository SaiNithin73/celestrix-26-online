...
const events = [
  {
    ...
    rules: ['ROUND 1 / TECH QUIZ — Answer CSBS-based questions covering programming, DBMS, operating systems, networks, OOP, web technologies, AI/ML, cloud, and business concepts. This round tests knowledge and speed.', 'ROUND 2 / ERROR FINDING — Find and fix syntax, logical, runtime, data-type, function, and SQL errors so the code runs correctly and produces the expected result.', 'ROUND 3 / COMBINATION — Understand the technical concept, analyze the problem, find the error, correct the code, and apply the right solution. The challenge grows from knowledge to skill to application.'],
    eligibility: 'Open to Computer Science and Business Systems (CSBS) students. QuizVerse progresses through three rounds: Knowledge, Skill, and Application.',
