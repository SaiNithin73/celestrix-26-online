...
const events = [
  {
    slug: 'quizverse', name: 'QUIZVERSE', subtitle: 'Enter the Space of Knowledge. Think Fast. Score High.', category: 'Technical', stone: 'SPACE STONE', accent: '#46b9ff', soft: 'rgba(70,185,255,.15)', icon: '◆',
